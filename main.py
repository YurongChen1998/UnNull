...
if __name__ == '__main__':
    ...
    if MSFA:
        ...
        # 'Harvard_S1' (3), 'CAVE_beads' (0.5), 'CAVE_cd' (0.1), 'CAVE_chart' (1), 'CAVE_clay' (1), 'CAVE_cloth' (5), 'CAVE_fake_bear' (1), 'CAVE_feathers' (1), 'CAVE_flowers' (3), 'CAVE_oil' （7）
        data_list = ['Harvard_S1'] 
